...
public class ListViewUtil {
     ...
     */
    public static <T> Callback<ListView<T>, ListCell<T>> factoryFor(Class<? extends DataViewContainer<DataPresenter<T>>> view) {
        return (p) -> createCell(view);
    }

    private static <T> ListCell<T> createCell(Class<? extends DataViewContainer<DataPresenter<T>>> view) {
        try {
